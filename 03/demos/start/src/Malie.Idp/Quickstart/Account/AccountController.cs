    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (await _users.ValidateClearTextCredentialsAsync(model.Username, model.Password))
                {
                    var user = await _users.GetUserByUserNameAsync(model.Username);
